...
- **ADR-014:** SOCKS5 dynamic mesh proxy for multi-target connectivity (SSH and kubectl) — **proposed, not implemented**; no SOCKS5 code exists and `connect --socks5` is rejected. Tracked as #186; the runbook is a design document.
